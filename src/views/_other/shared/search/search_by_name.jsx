// import SearchByName from 'shared/search/search_by_name'
'use strict'
...
export default class SearchByName extends Component {
  ...
  handleSearch = () => {
    ...
    if (value) {
      UIStore.search.setOnlyQueryAsin(value)
    } else {
      UIStore.search.setOnlyQueryAsin("")
    }
  }

  handleChange = (event) => {
    let value = event.target.value
    value == "" ? UIStore.search.setOnlyQueryAsin("") : null
